...
//  AutomatedPIREP
//
//  Created by Pruthvi Parne on 10/30/16.
...
//    func getRandomInRange(from:Double, to: Double, fixed:Double) {
//     (random() * (to - from) + from)
//    }
    ...
    class func storeLocations()-> [locations]{
        locationsArray=[locations(latitude: 33.636667, longitude: -84.428056),
                        ...
                        locations(latitude:37.09024, longitude: 14.72553),
                        locations(latitude:14.72553, longitude:-122.309444)
